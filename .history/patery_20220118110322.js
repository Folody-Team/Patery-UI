        ...
        (() => {
          if(document.querySelector("PateryButton") || document.querySelectorAll("PateryButton")) {
              document.querySelectorAll("PateryButton").forEach(function (e) {
                ...
                // first class name of button is PateryButton
                B.className = "PateryButton";
                // if PateryButton element has one more class then add it to button
                if (e.classList.length > 1) {
                  for (let i = 1; i < e.classList.length; i++) {
                    B.classList.add(e.classList[i]);
                  }
                }
                for (let i = 0; i < A.length; i++) {
