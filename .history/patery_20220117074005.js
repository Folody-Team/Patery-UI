...
const PateryElementTag = "Patery" + "";
// check if element is a Patery element
const PateryElementTagName = PateryElementTag + getStyleNames(document.body)[PateryElementTag[1]]
console.log(PateryElementTagName);
